...
const first: string = chalk.bold.yellowBright(`         | A | E | I | M | Q | U |`);
const second: string = chalk.bold.yellowBright(`        | B | F | J | N | R | V | Y |`);
const third: string = chalk.bold.yellowBright(`         | C | G | K | O | S | W | Z |`);
const fourth: string = chalk.bold.yellowBright(`        | D | H | L | P | T | X | `);
...
let NAME: string = chalk.bold.italic.redBright(finalName.join(""));
